 ...
 */
public class TcpSyslogHandler extends ExtHandler {
    ...
    public static enum SyslogType {
        /**
         * Formats the message according the the RFC-5424 (The Syslog Protocol) specification (<a href="http://tools.ietf.org/html/rfc5424#section-6">http://tools.ietf.org/html/rfc5424#section-6</a>
         */
        RFC5424 {
            @Override
        ...
        /**
         * Formats the message according the the RFC-3164 (The BSD syslog Protocol) specification (<a href="http://tools.ietf.org/html/rfc3164#section-4.1">http://tools.ietf.org/html/rfc3164#section-4.1</a>
         */
        RFC3164 {
            @Override
            protected String format(final ExtLogRecord record, final Facility facility, final String hostname, final String pid, final String appName) throws UnsupportedEncodingException {
     ...
     */
    public TcpSyslogHandler(final InetAddress serverAddress, final int port, final Facility facility, final SyslogType syslogType, final String hostname) throws IOException {
        this.serverAddress = serverAddress;
        this.port = port;
        this.facility = facility;
        System.out.println("creating socket..."+serverAddress.getHostAddress()+" : "+port); // TODO remove
        this.socket = SocketFactory.getDefault().createSocket(serverAddress, port);
        System.out.println("created socket"); // TODO remove
    ...
    public final void doPublish(final ExtLogRecord record) {
        System.out.println("doPublish"); // TODO remove
        ...
        synchronized (outputLock) {
            ...
            try {
                ...
                try {
                    ...
                    socketOut.flush();
                    System.out.println("flush"); // TODO remove
                }
            } catch (IOException e) {
